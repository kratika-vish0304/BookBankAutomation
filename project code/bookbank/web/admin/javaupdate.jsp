    ...
    <%
      ...
      String adms_no= request.getParameter("adms_no");
        try{
             ...
             String qry="select * from registration where sno="+adms_no;
    ...
    try
{
     ...
     con=DriverManager.getConnection("jdbc:mysql://localhost:3306/java","root","");
      String sql="Update registration set name=?,add_no=?,course=?,reciept_date=?,email=?,mobile=?,parent_mob=?,no_of_books=?,bank=?,ifsccode=?,reciept=?,acc_no=?,amount=?,bookname=? where sno="+adms_no;
