...
<body>
  ...
  <section id="one">
     <h1 class="text-center mx-3">Requests</h1>
     <form class="d-flex" method="get" action="search.jsp">
          <input class="form-control me-2 search" type="search" placeholder="Enter admission numberss" name="search" >
          <button class="btn btn-outline-success" type="submit" id="search">Search</button>
           <button class="btn btn-outline-success" id="export"><a href="requestpage_export.jsp" style="color: white;text-decoration: none;margin:0px;">Export</a></button>
        </form>
...
//        Statement st=null;
        ...
        try{
             ...
             <td class="col_td borderr"><a href="javaupdate.jsp?adms_no=<%=rs.getString("sno")%>" id="update" >Update</a></td>
                  <td class="col_td borderr"><a href="javaapprovedback.jsp?adms_no=<%=rs.getString("sno")%>"  id="delete">Approved</a></td>
