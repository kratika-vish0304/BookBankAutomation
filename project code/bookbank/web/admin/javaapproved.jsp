<%-- 
    Document   : javaapproved
    Created on : 02-Dec-2022, 8:40:34 pm
    Author     : Dell
--%>
  ...
  <section id="one">
     <h1 class="text-center mx-3">Approved Requests</h1>
      <form class="d-flex" method="get" action="searchapproved.jsp">
          ...
          <button class="btn btn-outline-success" type="submit" id="search">Search</button>
           <button class="btn btn-outline-success" id="export"><a href="approvedpage_export.jsp" style="color: white;text-decoration: none;margin:0px;">Export</a></button>
        </form>
     <table class="table borderr  table-striped mt-2">
        <thead class="borderr thead coll">
            <tr class="borderr ">
              ...
              <th scope="col" class="col borderr">passs bookname</th>
...
//        Statement st=null;
        ...
        try{
             ...
             String qry="select * from approved";
             ...
             while(rs.next())
             {
              ...
              <td class="col_td borderr"><a href="javaapprovedupdate.jsp?adms_no=<%=rs.getString("sno")%>" id="update" >Update</a></td>
